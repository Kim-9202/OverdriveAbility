...
#include "AbilitySystemFinders/OverdriveAbilitySystemFinder_PlayerState.h"
...
UAbilitySystemComponent* UOverdriveAbilitySystemFinder_PlayerState::FindAbilitySystem_Implementation(UActorComponent* InComponent) const
{
