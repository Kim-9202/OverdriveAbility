...
#include "OverdriveAbilitySystemFinder.generated.h"

class UAbilitySystemComponent;
class UActorComponent;

DECLARE_DELEGATE_OneParam(FOnOverdriveAbilitySystemFoundSignature, UAbilitySystemComponent*);
DECLARE_DELEGATE(FOnOverdriveAbilitySystemFindFailedSignature);
...
class OVERDRIVEABILITY_API UOverdriveAbilitySystemFinder : public UObject
{
	GENERATED_BODY()

public:
	FOnOverdriveAbilitySystemFoundSignature OnFound;
	FOnOverdriveAbilitySystemFindFailedSignature OnFailed;
...
protected:
	UFUNCTION(BlueprintNativeEvent, Category = "OverdriveAbility")
