 ...
 * 
 */
UCLASS(Abstract, DefaultToInstanced, Blueprintable, BlueprintType, EditInlineNew, Transient)
...
private:
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Phase", meta = (AllowPrivateAccess = "true"))
