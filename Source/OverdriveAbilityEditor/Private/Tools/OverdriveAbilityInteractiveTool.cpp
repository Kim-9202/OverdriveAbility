...
#include "OverdriveAbilityInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UOverdriveAbilityInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UOverdriveAbilityInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UOverdriveAbilityInteractiveTool* NewTool = NewObject<UOverdriveAbilityInteractiveTool>(SceneState.ToolManager);
...
UOverdriveAbilityInteractiveToolProperties::UOverdriveAbilityInteractiveToolProperties()
{
...
void UOverdriveAbilityInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UOverdriveAbilityInteractiveTool::Setup()
{
	...
	Properties = NewObject<UOverdriveAbilityInteractiveToolProperties>(this, "Measurement");
...
void UOverdriveAbilityInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UOverdriveAbilityInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UOverdriveAbilityInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UOverdriveAbilityInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UOverdriveAbilityInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UOverdriveAbilityInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UOverdriveAbilityInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UOverdriveAbilityInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UOverdriveAbilityInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
