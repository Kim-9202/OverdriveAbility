...
#include "OverdriveAbilityInteractiveTool.generated.h"


/**
 * Builder for UOverdriveAbilityInteractiveTool
 */
UCLASS()
class OVERDRIVEABILITYEDITOR_API UOverdriveAbilityInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UOverdriveAbilityInteractiveTool
 */
UCLASS(Transient)
class OVERDRIVEABILITYEDITOR_API UOverdriveAbilityInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UOverdriveAbilityInteractiveToolProperties();
...
/**
 * UOverdriveAbilityInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class OVERDRIVEABILITYEDITOR_API UOverdriveAbilityInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UOverdriveAbilityInteractiveToolProperties> Properties;
