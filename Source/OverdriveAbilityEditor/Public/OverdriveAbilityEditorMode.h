...
#include "OverdriveAbilityEditorMode.generated.h"
 ...
 */
UCLASS()
class UOverdriveAbilityEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_OverdriveAbilityEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UOverdriveAbilityEditorMode();
	virtual ~UOverdriveAbilityEditorMode();
